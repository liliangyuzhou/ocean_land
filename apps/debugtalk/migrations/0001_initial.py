    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='debugtalk.py', help_text='测试套件名称', max_length=200, verbose_name='DebugTalks名称')),
                ('debugtalk', models.TextField(default='#debugtalk.py', help_text='debugtalk文件内容', null=True, verbose_name='debugtalk文件内容')),
            ...
            options={
                ...
                'verbose_name_plural': 'debugtalks.py',
